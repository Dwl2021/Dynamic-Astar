...
void EDTEnvironment::getSurroundDistance(Eigen::Vector3d pts[2][2][2],
                                         double dists[2][2][2])
{
  for (int x = 0; x < 2; x++)
  {
...
pair<double, Eigen::Vector3d> EDTEnvironment::interpolateTrilinear(
    double values[2][2][2], const Eigen::Vector3d& diff, double& value,
    Eigen::Vector3d& grad)
{
...
pair<double, Eigen::Vector3d> EDTEnvironment::evaluateEDTWithGrad(
